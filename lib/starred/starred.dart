...
class StarredCubit extends HydratedCubit<EntryState> {
  StarredCubit() : super(EntryState({}));
  ...
  void replace(Iterable<int> ids) => emit(EntryState(ids));

  @override
  EntryState fromJson(Map<String, dynamic> json) =>
      EntryState.fromJson(json['starred'] as Map<String, dynamic>);

  @override
  Map<String, dynamic>? toJson(EntryState state) => {'starred': state.toJson()};
}
